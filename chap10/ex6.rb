...
while now_number > 2
puts english_number(now_number).capitalize + " bottles of beer on the wall, " +  english_number(now_number) + " bottles of beer."
now_number = now_number - 1
puts "You take one down and glug it down, " + english_number(now_number) + " bottles of beer on the wall..."
end
